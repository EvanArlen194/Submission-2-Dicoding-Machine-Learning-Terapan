...
2. **Visualisasi Distribusi Genre**:
   - Menggunakan `sns.countplot()` untuk memvisualisasikan distribusi genre film dalam dataset. Visualisasi tersebut menunjukkan bahwa genre drama merupakan genre film yang paling dominan, dengan jumlah kemunculan yang jauh melampaui genre lainnya. Hal ini mencerminkan kecenderungan industri film untuk memproduksi lebih banyak film bergenre drama, kemungkinan karena drama memiliki cakupan cerita yang luas dan daya tarik emosional yang tinggi bagi penonton. Di posisi berikutnya, genre komedi dan thriller juga cukup menonjol, menunjukkan bahwa film-film dengan unsur hiburan dan ketegangan tetap memiliki tempat yang kuat di hati penonton. Genre seperti romantis, aksi, dan horor juga tampil cukup signifikan, meskipun tidak sebanyak tiga genre teratas. Sementara itu, genre-genre seperti dokumenter, animasi, sejarah, dan musik menunjukkan frekuensi yang lebih rendah, yang bisa mengindikasikan segmentasi penonton yang lebih sempit atau tingkat produksi yang lebih rendah. Beberapa genre seperti film TV, western, dan perang berada di posisi terbawah dalam distribusi ini, menunjukkan bahwa genre-genre tersebut tergolong niche dan mungkin kurang populer dalam beberapa tahun terakhir. Pola distribusi ini bisa menjadi dasar untuk berbagai analisis lebih lanjut, baik untuk kebutuhan rekomendasi film, penentuan strategi produksi, maupun studi tren minat audiens.
